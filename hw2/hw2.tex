...
\begin{homeworkProblem}[3.5]
    ...
    \\
    \vspace{0.5in}
    First we need to assign coordinate frames 0 through 3 (links 0 through 3). This is done as per the following figure.
    \begin{figure}[h]
        \includegraphics[scale=0.4]{problem-3-5-figure-frames.png}
        \centering
    \end{figure}

    Now, we need to create a table for quantities \(\alpha_i, a_i, \theta_i, d_i\) for links 1 through 3.
