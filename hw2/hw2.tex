...
\begin{homeworkProblem}[5.5]
    ...
    now denoted by vector $o_c$, coincide with the point $(x_c,y_c,z_c)$ as we found in Problem 5--3. However, for the sake of
    clearly denoting $d_3$ as joint variable $q_3$, we have now used $u_3$ in the figure. It is still the same distance found in Problem 5--3.
    \begin{figure}[h]
