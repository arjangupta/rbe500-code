...
\begin{homeworkProblem}[Question 2]
    ...
    \vspace{0.15mm}
    \begin{itemize}
        \item First, we choose the step function as the input block.
        ...
        \item Now we add a summation after the input, and edit it by double-clicking the summation and making sure it says $| \hspace{1mm} + \hspace{1mm} -$.
        ...
        \item Finally, the output of the summation right after the input feeds into our controller.
...
\begin{homeworkProblem}[Question 3]
    ...
    Therefore, the settling time $T_s$ is 4.2 seconds.\\
    \vspace{0.05in}\\
    Now we write the following script to tune our $K_p$ and $K_d$ values.
