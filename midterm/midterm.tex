...
\begin{homeworkProblem}[Question 6]
    ...
    \begin{enumerate}
        ...
        \item $z_4$ is the third column of $R^0_5$, which is the upper-left $3\times3$ section of the $H^0_5 = T_5 = A_1A_2A_3A_4A_5$ matrix.
    ...
    ,
    A_6 = \begin{bmatrix}\cos\left(\theta _{5}\right) & -\sin\left(\theta _{5}\right) & 0 & 0\\ \sin\left(\theta _{5}\right) & \cos\left(\theta _{5}\right) & 0 & 0\\ 0 & 0 & 1 & l_{6}\\ 0 & 0 & 0 & 1 \end{bmatrix}
    \]
