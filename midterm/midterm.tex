...
\begin{homeworkProblem}[Problem 4]
    ...
    \begin{figure}[h]
        \includegraphics[scale=0.4]{q4_figure_sola.png}
        \centering
    \end{figure}

    Now, we create a table for quantities \(\alpha_i, a_i, \theta_i, d_i\) for links 1 through 5.
    ...
    \begin{table}[h!]
        \begin{center}
            ...
            3 & 0 & 0 & 0 & $d_3$\\
            4 & $90\degree$ & 0 & $180\degree$ & $d_4$\\
            5 & $90\degree$ & 0 & $180\degree$ & $d_5$\\
            \hline
            \end{tabular}
        \end{center}
    \end{table}
